    ...
    useEffect(() => {
        const unsubscribe = auth.onAuthStateChanged((user) => {
            ...
            if (user) {
                ...
                // axios.post('https://yoga-master-server.onrender.com/api/set-token', { email: user.email, name: user.displayName })
                axios.post('https://gaming-hustler-server.onrender.com/api/set-token', { email: user.email, name: user.displayName })
                    .then(data => {
