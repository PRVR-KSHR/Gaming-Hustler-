...
const Hero = () => {
    return (
        <div className='min-h-screen bg-cover rounded-b-3xl' style={{ backgroundImage: 'url("https://i.ibb.co/pJZyS8X/banner-1.gif")' }}>
            <div className="min-h-screen flex justify-start pl-11 text-white items-center bg-black bg-opacity-60 rounded-b-3xl">
                <div className="">
                    <div className="space-y-4">
                        ...
                        <h1 className='md:text-7xl text-4xl font-bold '>Best Esports <br/>Tournament Online</h1>
                        <div className="font-bold text-orange-200">
                            <p className=''>Where champions are made: join our elite Esports Tournaments online.</p>
                        </div>
                        <div className="flex flex-wrap items-center gap-5">
                            <button onClick={() => (window.location.href = "/register")} className='px-7 py-3 rounded-lg bg-secondary font-bold uppercase hover:bg-sky-700'>Join Now</button>
