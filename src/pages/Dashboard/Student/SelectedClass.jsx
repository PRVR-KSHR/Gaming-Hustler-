...
const SelectedClass = () => {
    ...
    return (
        <div>
            <div className="my-6">
                <h1 className='text-4xl text-center font-bold'>My <span className='text-secondary'>Selected</span> Tournaments</h1>
            </div>
            <div className="h-screen py-8">
                <div className="container mx-auto px-4">
                    <h1 className="text-2xl font-semibold mb-4">Tournaments Cart</h1>
                                ...
                                <table className="w-full">
                                    <thead>
                                        <tr>
                                            ...
                                            <th className="text-left font-semibold">Tournament</th>
                                            ...
                                            classes.length === 0 ? <tr><td colSpan='5' className='text-center text-2xl font-bold'>No Classes Found</td></tr> :
                                                paginatedData.map((item, idx) => {
                                                    ...
                                                    return <tr key={item._id}>
                                                        ...
                                                        <td className="py-4">₹{parseInt(item.prizePoolFirst) + parseInt(item.prizePoolSecond) + parseInt(item.prizePoolThird)}</td>
                                                        <td className="py-4">
