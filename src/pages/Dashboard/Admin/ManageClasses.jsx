...
const ManageClasses = () => {
    ...
    const handleApprove = (id) => {
        axiosSecure.put(`/change-status/${id}`, { status: 'approved' })
            ...
            .catch(err => {
            console.log(err);
            toast.error('Failed to approve the tournament.');
        })
    }
const handelReject = (id) => {
    Swal.fire({
        title: 'Are you sure?',
        text: 'You are about to reject this tournament.',
        icon: 'warning',
        ...
        if (result.isConfirmed) {
            axiosSecure.put(`/change-status/${id}`, { status: 'rejected' })
                .then(res => {
                    console.log(res.data)
                ...
                .catch(err => {
                    ...
                    Swal.fire(
                        'Error',
                        'Failed to reject the tournament.',
                        'error'
                    )
                })
        }
    ...
    return (
        <div>
            <h1 className='text-4xl text-secondary font-bold text-center my-10'>Manage <span className='text-black'>Tournaments</span></h1>
                                ...
                                <table className="min-w-full text-left text-sm font-light">
                                    <thead className="border-b font-medium dark:border-neutral-500">
                                        <tr>
                                            ...
                                            <th scope="col" className="px-6 py-4">TOURNAMENT NAME</th>
                                            <th scope="col" className="px-6 py-4">HOST NAME</th>
                                    ...
                                    <tbody>
                                        {
                                            classes.length == 0 ? <tr><td colSpan='6' className='text-center text-2xl font-bold'>No Tournaments Found</td></tr> :
