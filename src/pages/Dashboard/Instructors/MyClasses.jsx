...
const MyClasses = () => {
    ...
    const handleFeedback = (id) => {
        // Your existing feedback handling logic
    };
    ...
    return (
        <div>
            <div className="my-9">
                <h1 className='text-4xl font-bold text-center '>My <span className='text-secondary'>Tournaments</span></h1>
                <div className="text-center">

                    <Fade duration={100} className='text-[12px]  text-center' cascade>Here you can see how many tournaments added by you and all tournaments status</Fade>
                </div>


                <div className="">
                    {
                        classes.length === 0 ? <div className='text-center text-2xl font-bold mt-10'>You have not added any tournaments yet</div> :
                            <div className="mt-9">
                                {
                                            ...
                                            <div className="w-full">
                                                ...
                                                <div className="flex gap-5">
                                                    <div className="">
                                                        ...
                                                        <h1 className='text-secondary'><span className='text-black '>Total Seats</span> : {cls.slot}</h1>
                                                    ...
                                                    <div className="">
                                                        ...
                                                        <h1 className='text-secondary my-2'><span className='text-black '>Price</span> : ₹{parseInt(cls.prizePoolFirst) +
                            parseInt(cls.prizePoolSecond) +
                            parseInt(cls.prizePoolThird)} <span className='text-black'></span></h1>
                                                    ...
                                                    <div className="w-1/3">
                                                        ...
                                                        <button className='px-3 bg-secondary font-bold  py-1 text-white w-full rounded-lg my-3' onClick={() => navigate(`/dashboard/update/${cls._id}`)}>Update</button>
                                                        <button onClick={() => handleDelete(cls._id)} className='px-3 bg-red-600 font-bold py-1 text-white w-full rounded-lg '>Delete</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
