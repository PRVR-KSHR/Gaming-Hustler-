...
const NavBar = () => {
    ...
    if (isDarkMode) {
        ...
        setNavBg('bg-[#17161a] dark:bg-black dark:text-white text-black'); // Change background color to #17161a in dark mode
    } else {
        root.classList.remove(darkClass);
        setNavBg('bg-[#15151580]'); // Set the default background color for light mode
    }
}, [isDarkMode]);
    useEffect(() => {
                    ...
                    <div className="hidden  text-black dark:text-white md:block">
                        <div className="flex">
                            <ul className="ml-10 flex items-center space-x-4 pr-4">
                                ...
                                {
                                    user && <li><NavLink className='font-bold px-3 py-2 bg-secondary text-white rounded-xl hover:bg-sky-700' onClick={handelLogout}>Logout</NavLink></li>
                                }
                                <li>
