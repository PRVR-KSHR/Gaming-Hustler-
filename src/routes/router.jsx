...
export const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                path: "class/:id",
                element: <SingleClass/>,
                // loader: ({ params }) => fetch(`https://yoga-master-server.onrender.com/class/${params.id}`),
                loader: ({ params }) => fetch(`https://gaming-hustler-server.onrender.com/class/${params.id}`),
            }
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                // loader: ({ params }) => fetch(`https://yoga-master-server.onrender.com/users/${params.id}`),
                loader: ({ params }) => fetch(`https://gaming-hustler-server.onrender.com/users/${params.id}`),
            },
            {
                path: 'admin-home',
